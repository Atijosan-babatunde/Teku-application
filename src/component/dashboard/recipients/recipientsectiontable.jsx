...
const RecipientSectionTable = () => {
    ...
    const recipientData = useAppSelector((state) => state.transaction.getRecipientUsersData)
    const [data] = useState(recipientData)
    ...
    const [subtitle] = useState([
        { id: 1, imgs: <img src={eye} className={styles.icon} alt='imgone' />, text: 'Edit' },
        { id: 2, imgs: <img src={flyarrow} className={styles.icon} alt='imgtwo' />, text: 'Transfer money' },
        { id: 3, imgs: <img src={download} className={styles.icon} alt='imgthree' />, text: 'Download document' },
        { id: 3, imgs: <img src={deleteimg} className={styles.icon} alt='imgfour' />, text: 'Delete' },
    ])
