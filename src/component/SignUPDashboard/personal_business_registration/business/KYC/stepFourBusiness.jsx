import styles from '../KYC/CSS/stepfourbusiness.module.scss'
import steptwoimg from '../../../../../assets/png/phonecall.png'
import PhoneInput from "react-phone-input-2";
import { useState } from 'react';
import { BsArrowLeft } from 'react-icons/bs'

const StepFourBusiness = ({setStep}) => {
    ...
    return (
        <div className={styles.parent}>
            {stepOtp === 1 && (
                <div>
                    <h1 className={styles.stepnumber}><BsArrowLeft onClick={goToStepTwo} className={styles.arrow}/>Step 4</h1>
