  ...
  return (
    <div className={styles.parent}>
      <h1 className={styles.stepnumber}>
        <BsArrowLeft onClick={goToStepFour} className={styles.arrow} />
        Step 5
      </h1>
      ...
      <div className={styles.content}>
        <img src={envelop} alt="" />
        <p>
          Your verification is pending, this may take few hours depending on
          some factors. If your status does not change in the next 24hours,
          kindly send us a message.
        </p>
      </div>
      <div className={styles.requestbut}>
        <button className={styles.btnrequest} onClick={goToDashboard}>
