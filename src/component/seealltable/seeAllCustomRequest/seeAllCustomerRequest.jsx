                ...
                <div className={styles.desc}>
                    <div className={styles.descone}>
                        ...
                        <Dropdown isOpen={menuTwo} toggle={() => setMenuTwo(!menuTwo)} style={{ cursor: 'pointer' }} >
                            ...
                            <DropdownMenu className={styles.dropBox}>
                                {amountTwo.map(amount =>
                                    <DropdownItem className={styles.value} onClick={() => changeValueTwo(amount)}>{amount.amount} </DropdownItem>
                                )}
                            </DropdownMenu>
                        </Dropdown>
                    </div>
                    <div className={styles.desctwo}>
                        ...
                        <Dropdown isOpen={menu} toggle={() => setMenuThree(!menuThree)} style={{ cursor: 'pointer' }} >
                            <DropdownToggle tag="a" className={styles.dropdownToggle} >
                            ...
                            <DropdownMenu className={styles.dropBox}>
                                {amountThree.map(amount =>
                                    <DropdownItem className={styles.value} onClick={() => changeValueThree(amount)}>{amount.amount} </DropdownItem>
                                )}
                            </DropdownMenu>
                        </Dropdown>
                        ...
                        <Dropdown isOpen={menu} toggle={() => setMenuFour(!menuFour)} style={{ cursor: 'pointer' }} >
                            <DropdownToggle tag="a" className={styles.dropdownToggle} >
                            ...
                            <DropdownMenu className={styles.dropBox}>
                                {amountFour.map(amount =>
                                    <DropdownItem className={styles.value} onClick={() => changeValueFour(amount)}>{amount.amount} </DropdownItem>
                                )}
                            </DropdownMenu>
                        </Dropdown>
                    </div>
